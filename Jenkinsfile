        ...
        script {
          ...
          secretKeyVariable: 'AWS_SECRET_ACCESS_KEY']]) {
            ...
            if (params.cloudwatch == true) {
              ...
              sh """
                curl https://github.com/syamtumati/eks-terraform-helm/cwagent-fluentd-quickstart.yaml | \\
            ...
            if (params.ca == true) {
              ...
              sh """
                kubectl apply -f https://github.com/syamtumati/eks-terraform-helm/cluster-autoscaler-autodiscover.yaml
            ...
            if (params.nginx_ingress == true) {
              ...
              sh """
                ...
                git clone https://github.com/syamtumati/kube-ingress.git
                cd kube-ingress/deployments/
      ...
      steps {
        script {
          ...
          withCredentials([[$class: 'AmazonWebServicesCredentialsBinding', 
            ...
            sh """
              [ -d kube-ingress ] && rm -rf kube-ingress
              git clone https://github.com/syamtumati/kube-ingress.git

              # Need to clean this up otherwise the vpc can't be deleted
              kubectl delete -f kube-ingress/deployments/service/loadbalancer-aws-elb.yaml || true
              [ -d kube-ingress ] && rm -rf kube-ingress
              sleep 20
